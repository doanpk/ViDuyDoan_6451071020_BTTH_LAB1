      ...
      child: ElevatedButton(
        ...
        child: Row(
          ...
          children: [
            ...
            Text(text, style: const TextStyle(color: AppColors.primary, fontWeight: FontWeight.bold)),
          ],
        ),
      ),
    );
...
class CustomTextField extends StatefulWidget {
  ...
  const CustomTextField({Key? key, required this.label, this.isPassword = false}) : super(key: key);
...
class _CustomTextFieldState extends State<CustomTextField> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Text(widget.label, style: const TextStyle(color: AppColors.primary, fontWeight: FontWeight.bold, fontSize: 12)),
        ...
        TextField(
          ...
          decoration: InputDecoration(
            ...
            suffixIcon: widget.isPassword
              ...
              onPressed: () {
                setState(() { _obscureText = !_obscureText; }); // Đảo trạng thái ẩn/hiện
              },
            )
                : null,
          ),
...
// 5. Nút Checkbox "Remember me" (MỚI THÊM ĐỂ BẤM TICK ĐƯỢC)
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        const SizedBox(width: 8),
        const Text("Remember me", style: TextStyle(color: AppColors.textLight, fontSize: 12)),
      ],
    );
  }
}